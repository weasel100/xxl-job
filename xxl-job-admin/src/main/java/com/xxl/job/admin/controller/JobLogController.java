...
public class JobLogController {
    ...
    public Map<String, Object> pageList(@RequestParam(required = false, defaultValue = "0") int start,
        ...
        // page query
        List<XxlJobLog> list = xxlJobLogDao.pageList(start+1, start + length, jobGroup, jobId, triggerTimeStart, triggerTimeEnd, logStatus);
    ...
    public String logDetailPage(int id, Model model) {
        ...
        model.addAttribute("triggerTime", DateUtil.parseDateTime(jobLog.getTriggerTime()).getTime());
